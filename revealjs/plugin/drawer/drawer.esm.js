...
export default function () {
  ...
  function g() {
    if (
      ((y.dirty = !1), (y.prevX = y.x), (y.prevY = y.y), 0 === p.paths.length)
    )
      return !1;
  ...
  function h() {
    p.drawerElementContext.clearRect(
      0,
      0,
      p.drawerElement.width,
      p.drawerElement.height
    );
    var e,
      t = n(p.paths);
    try {
  ...
  function w(e) {
    ...
    (y.x = e.pageX),
      ...
      !y.dirty &&
        f &&
        1 === e.buttons &&
        ((y.dirty = !0), requestAnimationFrame(g));
  }
  function C(n) {
    g(),
  ...
  var x = function (n) {
    (e.color = n),
      null != m && m({ type: "pointerColorChange", data: { color: n } }),
      C();
  };
  function S(n) {
    (m = n.dispatchEvent),
    ...
    (s.style.display = "none" === s.style.display ? "block" : "none"),
      (r = "none" !== s.style.display)
        ? (document.addEventListener("keydown", K),
          ...
          (f = !0),
          null != m &&
            m({ type: "pointerColorChange", data: { color: e.color } }))
        : (document.removeEventListener("keydown", K),
          document.removeEventListener("keydown", L),
          E(),
          (f = !1),
          null != m &&
            m({ type: "pointerColorChange", data: { color: null } }));
  }
  function A(e) {
