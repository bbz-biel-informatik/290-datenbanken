...
![alt text](bilder/erd-1-mitarbeiterverzeichnis.drawio.svg)

![alt text](bilder/erd-1.2-LS-mitarbeiterverzeichnis.drawio.svg)
...
![alt text](bilder/erd-2-skiverzeichnis.drawio.svg)

![alt text](bilder/erd-2.1-LS-skiverzeichnis.drawio.svg)
...
![alt text](bilder/erd-3-spotify.drawio.svg)

![alt text](bilder/erd-3.1-LS-spotify.drawio.svg)
...
![alt text](bilder/erd-4-amazon-lieferanten.drawio.svg)

![alt text](bilder/erd-4.1-LS-amazon-lieferanten.drawio.svg)
...
![alt text](bilder/erd-5-bewertungen.drawio.svg)

![alt text](bilder/erd-5.1-LS-bewertungen.drawio.svg)
...
![alt text](bilder/erd-6-fussball.drawio.svg)

![alt text](bilder/erd-6.1-LS-fussball.drawio.svg)
...
![alt text](bilder/erd-7-bestellabwicklung.drawio.svg)

![alt text](bilder/erd-7.1-LS-bestellabwicklung.drawio.svg)